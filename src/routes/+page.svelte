...
<main class="flex min-h-[100dvh] flex-col space-y-10">
			...
			<div class="flex justify-between gap-2">
				<div class="flex flex-1 flex-col space-y-1.5">
					<BlurFade
						...
						yOffset={8}>Sihem Bouhenniche</BlurFade
					>
					<BlurFade class="max-w-[600px] md:text-xl" delay={BLUR_FADE_DELAY}
						>Cybersecurity and Privacy PhD researcher <br> Android device fingerprinting.</BlurFade
					>
				</div>
	...
	<section id="projects">
		<div class="w-full space-y-12 py-12">
			<BlurFade delay={BLUR_FADE_DELAY}>
				<h2 class="text-xl font-bold">Medium Articls</h2>
			</BlurFade>
